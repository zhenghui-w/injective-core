...
func InitEVMParams(ctx sdk.Context, app upgrades.InjectiveApplication, _ log.Logger) error {
	...
	// For local testing, add our funded accounts to authorized deployers
	if cosmosChainID == "injective-1" && strings.Contains(cosmosChainID, "local") {
		// Local testing mode - allow all accounts
	...
	evmParams.AuthorizedDeployers = []string{
		...
		// Add our funded accounts for testing
		"0x7cB61D4117AE31a12E393a1Cfa3BaC666481D02E", // localkey (VAL_KEY)
